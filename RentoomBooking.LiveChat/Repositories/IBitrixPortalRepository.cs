...
{
    Task<BitrixLiveChatPortalEntity?> GetByMemberIdAsync(string memberId, bool trackChanges = false,
        CancellationToken ct = default);

    Task<BitrixLiveChatPortalEntity?> GetByDomainAsync(string domain, bool trackChanges = false,
        CancellationToken ct = default);
