...
namespace RentoomBooking.LiveChat.Migrations
{
    ...
    [Migration("20260422090000_AddIndexesAndContentMaxLength")]
    partial class AddIndexesAndContentMaxLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentoomBooking.LiveChat.Entities.LiveChatSessionEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("AgentJoinedNotifiedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("agent_joined_notified_at");
